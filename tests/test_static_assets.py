...
class StaticAssetTests(unittest.TestCase):
    ...
    def test_podium_cache_busts_assets(self):
        ...
        self.assertIn('/static/style.css?v=presentation-13', html)
        self.assertIn('/static/presentation.js?v=presentation-13', html)
        self.assertIn('/static/podium.js?v=presentation-13', html)
